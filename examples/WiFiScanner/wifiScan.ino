...
U8G2_SH1106_128X64_NONAME_F_HW_I2C u8g2(U8G2_R0, U8X8_PIN_NONE); // CHANGE THIS TO YOUR IMPLEMENTATION
PixelView pv(&u8g2, sendInput, [](int ms) { vTaskDelay(pdMS_TO_TICKS(ms)); }, u8g2_font_haxrcorp4089_tr);
PixelView::Keyboard kbd(pv);
...
void wifiScanner(PixelView *pv, PixelView::Keyboard *kyb, U8G2 *u8g2) {
  ...
  if (n == 0) {
    pv->showMessage("No networks found");
    return;
  }
